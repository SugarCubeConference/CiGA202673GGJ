...
namespace GladeAgenticAI.Core.Tools.Implementations.Physics
{
    public class AddRigidbodyTool : ITool
    {
        ...
        private static void ApplyRigidbodyProperties(Rigidbody rb, Dictionary<string, object> args)
        {
            ...
            if (args.ContainsKey("drag") && float.TryParse(args["drag"].ToString(), System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out float drag)) rb.drag = drag;
            if (args.ContainsKey("angularDrag") && float.TryParse(args["angularDrag"].ToString(), System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out float angularDrag)) rb.angularDrag = angularDrag;
